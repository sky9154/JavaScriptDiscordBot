                ...
                switch (res.data.live) {
                    case 'none':
                        ...
                        const noneEmbed = new MessageEmbed()
                            ...
                            .setFooter({ text: 'Powered by nakiri.canaria.cc', iconURL: 'https://nakiri.canaria.cc/src/logo/apple-touch-icon-next.png' });
                        return interaction.reply({ embeds: [noneEmbed], components: [liveLinkBtn] });
                    case 'upcoming':
                        const upcomingEmbed = new MessageEmbed()
                            ...
                            .setThumbnail('https://cdn.discordapp.com/attachments/900320455477579836/983666002493591562/nakiri.jpg')
                            .setFooter({ text: 'Powered by nakiri.canaria.cc', iconURL: 'https://nakiri.canaria.cc/src/logo/apple-touch-icon-next.png' });
                        return interaction.reply({ embeds: [upcomingEmbed], components: [liveLinkBtn] });
                    case 'live':
                        const liveEmbed = new MessageEmbed()
                            ...
                            .setThumbnail('https://cdn.discordapp.com/attachments/900320455477579836/983666002493591562/nakiri.jpg')
                            .setFooter({ text: 'Powered by nakiri.canaria.cc', iconURL: 'https://nakiri.canaria.cc/src/logo/apple-touch-icon-next.png' });
                        return interaction.reply({ embeds: [liveEmbed], components: [liveLinkBtn] });
                    default:
